...
if (write) {
  ...
  library(readr)
  write_csv(fixed, "inst/output/simulations/simulation1/fixed.csv")
  write_csv(predictions, "inst/output/simulations/simulation1/predictions.csv")
  write_csv(objectives, "inst/output/simulations/simulation1/objectives.csv")
  write_csv(covparams, "inst/output/simulations/simulation1/covparams.csv")
  write_csv(seeds, "inst/output/simulations/simulation1/seeds.csv")
}
