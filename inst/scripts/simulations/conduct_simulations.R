conduct_simulations <- function(simseed = NULL, n, covparams, cors, beta, error = "normal") {
  ...
  #   error_sign <- sign(data_error)
  #   transformed_error <- error_sign * exp(abs(data_error)^(1/3))
