...
# Run the conduct simulations function for simulation 3 -----------------------
set.seed(3)
...
if (write) {
  ...
  library(readr)
  write_csv(fixed, "inst/output/simulations/simulation3/fixed.csv")
  write_csv(predictions, "inst/output/simulations/simulation3/predictions.csv")
  write_csv(objectives, "inst/output/simulations/simulation3/objectives.csv")
  write_csv(covparams, "inst/output/simulations/simulation3/covparams.csv")
  write_csv(seeds, "inst/output/simulations/simulation3/seeds.csv")
}
