...
cov_tempx <- ggplot(t_plot_pos) +
  ...
  theme(axis.title.x = element_text(face = "bold", size = axistext_size, margin = margin(t = 10, r = 0, b = 0, l = 0)),
  ...
  annotate("text", x = t_rangetol + brspace + 5 * brlen, y = s_de + s_ie / 2, label = TeX("$\\sigma^2_{s, ie}$"), size = annotate_size, color = "black") +
  # spatial dependent
  ...
  annotate("text", x = t_rangetol + brspace + 5 * brlen + 2 * brlen, y = s_de / 2, label = TeX("$\\sigma^2_{s, de}$"), size = annotate_size, color = "black") +
  ...
  annotate("text", x = - (brspace + 5 * brlen), y = t_de + t_ie / 2, label = TeX("$\\sigma^2_{t, ie}$"), size = annotate_size, color = "black") +
  # temporal dependent
  ...
  annotate("text", x = - (brspace + 5 * brlen + 2 * brlen), y = t_de / 2, label = TeX("$\\sigma^2_{t, de}$"), size = annotate_size, color = "black")


if (write) {
  ggsave(plot = cov_tempx, width = 9, height = 7, units = "in", filename = paste0(pathsave, "/cov_tempx.jpeg"), dpi = 1200)
}
...
cov_spx <- ggplot(s_plot_pos) +
  ...
  annotate("text", x = - (brspace + 5 * brlen), y = s_de + s_ie / 2, label = TeX("$\\sigma^2_{s, ie}$"), size = annotate_size, color = "black") +
  # spatial dependent
  ...
  annotate("text", x = - (brspace + 5 * brlen + 2 * brlen), y = s_de / 2, label = TeX("$\\sigma^2_{s, de}$"), size = annotate_size, color = "black") +
  # temporal independent
  ...
  annotate("text", x = s_rangetol + (brspace + 5 * brlen), y = t_de + t_ie / 2, label = TeX("$\\sigma^2_{t, ie}$"), size = annotate_size, color = "black") +
  # temporal dependent
  ...
  annotate("text", x = s_rangetol + (brspace + 5 * brlen + 2 * brlen), y = t_de / 2, label = TeX("$\\sigma^2_{t, de}$"), size = annotate_size, color = "black")

if (write) {
  ggsave(plot = cov_spx, width = 9, height = 7, units = "in", filename = paste0(pathsave, "/cov_spx.jpeg"), dpi = 1200)
}
...
sv_tempx <- ggplot(t_plot_pos) +
  ...
  annotate("text", x = t_rangetol + brspace + 5 * brlen, y = total_var - (s_de + s_ie / 2), label = TeX("$\\sigma^2_{s, ie}$"), size = annotate_size, color = "black") +
  # spatial dependent
  ...
  annotate("text", x = t_rangetol + brspace + 5 * brlen + 2 * brlen, y = total_var - s_de / 2, label = TeX("$\\sigma^2_{s, de}$"), size = annotate_size, color = "black") +
  # temporal  independent
  ...
  annotate("text", x = - (brspace + 5 * brlen), y = total_var - (t_de + t_ie / 2), label = TeX("$\\sigma^2_{t, ie}$"), size = annotate_size, color = "black") +
  # temporal dependent
  ...
  annotate("text", x = - (brspace + 5 * brlen + 2 * brlen), y = total_var - t_de / 2, label = TeX("$\\sigma^2_{t, de}$"), size = annotate_size, color = "black")


if (write) {
  ggsave(plot = sv_tempx, width = 9, height = 7, units = "in", filename = paste0(pathsave, "/sv_tempx.jpeg"), dpi = 1200)
}
...
sv_spx <- ggplot(s_plot_pos) +
  ...
  annotate("text", x = - (brspace + 5 * brlen), y = total_var - (s_de + s_ie / 2), label = TeX("$\\sigma^2_{s, ie}$"), size = annotate_size, color = "black") +
  # spatial dependent
  ...
  annotate("text", x = - (brspace + 5 * brlen + 2 * brlen), y = total_var - s_de / 2, label = TeX("$\\sigma^2_{s, de}$"), size = annotate_size, color = "black") +
  # temporal independent
  ...
  annotate("text", x = s_rangetol + (brspace + 5 * brlen), y = total_var - (t_de + t_ie / 2), label = TeX("$\\sigma^2_{t, ie}$"), size = annotate_size, color = "black") +
  # temporal dependent
  ...
  annotate("text", x = s_rangetol + (brspace + 5 * brlen + 2 * brlen), y = total_var - t_de / 2, label = TeX("$\\sigma^2_{t, de}$"), size = annotate_size, color = "black")

if (write) {
  ggsave(plot = sv_spx, width = 9, height = 7, units = "in", filename = paste0(pathsave, "/sv_spx.jpeg"), dpi = 1200)
}
