...
covparams <- list(s_de = 8, s_ie = 2, t_de = 8, t_ie = 2,
                  st_de = 5, st_ie = 5, s_range = 0.5 * sqrt(2), t_range = 0.5 * 1)
...
if (write) {
  write.csv(fixed, paste0(path, "simulation1/simulation1_fixed.csv"))
  write.csv(predictions, paste0(path, "simulation1/simulation1_predictions.csv"))
  write.csv(objectives, paste0(path, "simulation1/simulation1_objectives.csv"))
  write.csv(covparams, paste0(path, "simulation1/simulation1_covparams.csv"))
  write.csv(seeds, paste0(path, "simulation1/simulation1_seeds.csv"))
}
