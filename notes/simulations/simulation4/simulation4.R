...
if (write) {
  write.csv(fixed, paste0(path, "simulation4/simulation4_fixed.csv"))
  write.csv(predictions, paste0(path, "simulation4/simulation4_predictions.csv"))
  write.csv(objectives, paste0(path, "simulation4/simulation4_objectives.csv"))
  write.csv(covparams, paste0(path, "simulation4/simulation4_covparams.csv"))
  write.csv(seeds, paste0(path, "simulation4/simulation4_seeds.csv"))
}
